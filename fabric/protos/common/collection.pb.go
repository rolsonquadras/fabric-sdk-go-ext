...
const (
	CollectionType_UNKNOWN   CollectionType = 0
	CollectionType_PRIVATE   CollectionType = 1
	CollectionType_TRANSIENT CollectionType = 2
	CollectionType_DCAS      CollectionType = 3
)
...
type CollectionConfig struct {
	...
	//	*CollectionConfig_TransientCollectionConfig
...
type StaticCollectionConfig struct {
	...
	Type CollectionType `protobuf:"varint,9900,opt,name=type,enum=common.CollectionType" json:"type,omitempty"`
	...
	TimeToLive           string   `protobuf:"bytes,9901,opt,name=time_to_live,json=timeToLive" json:"time_to_live,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
